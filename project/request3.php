...
<aside id="aside2">
	...
	$desc=$_POST['d'];
	$_SESSION['desc']=$desc;
	$sql=mysqli_query($conn,"insert into candidate_request(eid,cid,cname,description,party) values('".$_SESSION['eid']."','".$_SESSION['cid']."','".$_SESSION['cun']."','".$_SESSION['desc']."','".$_SESSION['cpname']."')" );
	if($sql)
	{
